...
# codec settings
codec = dict(
    type='IntegralRegressionLabel', input_size=(640, 640), heatmap_size=(160, 160), sigma=2, normalize=True)
...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint='/data/mruthven/lite-hrnet-dsnt/weights/litehrnet18_mpii_256x256-cabd7984_20210623.pth'
    ))

# base dataset settings
dataset_type = 'SpeedPlusDataset'
data_mode = 'topdown'
data_root_train = '/data/mruthven/speedplus_640/sunlamp'
data_root_val = '/data/mruthven/speedplus_640/sunlamp'
